...
- Acceso al repositorio de la base de datos: [Shopping-Cart-Bd](https://github.com/KevinCuesta/Shopping-Cart-Bd/tree/dev)

## ConfiguraciÃ³n Inicial

1. **Clona el repositorio de la base de datos:**
   ```bash
   git clone https://github.com/KevinCuesta/Shopping-Cart-Bd.git
   cd Shopping-Cart-Bd
   ```
...
- **Base de datos:** [Shopping-Cart-Bd](https://github.com/KevinCuesta/Shopping-Cart-Bd/tree/dev)
- **Backend:** [Shopping-Cart-Backend](https://github.com/KevinCuesta/Shopping-Cart-Backend/tree/dev)
- **Frontend:** [Shopping-Cart-Frontend](https://github.com/KevinCuesta/Shopping-Cart-Frontend/tree/dev)
